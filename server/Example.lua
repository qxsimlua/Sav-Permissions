...
RegisterCommand('Request_Patch_SetNickNAme', function(source)
    ...
    if discordId then
        ...
        local Error,member = exports[GetCurrentResourceName()]:RequestApi("PATCH", endpoint, json.encode({nick = tostring(name)}), "Sav Development")
...
RegisterCommand('sendlog', function()
    exports['Sav-Permissions']:DiscordLogs('webhooks/1174927032367460452/wCCkybboX5wVVonvTkebIssXTdUkFpJImlV7yMXSQ4W3FJqZ_K4ma77SMYkXdR1L6DPl', 'Title', ' Description .gg/Sav #Ad')
end)