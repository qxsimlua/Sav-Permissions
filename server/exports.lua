...
local function DiscordLogs(webhook, title, description)
    local embedData = {
        ...
        footer = {
            ...
            icon_url = "https://cdn.discordapp.com/attachments/1152154696304304198/1154462827684319373/PFP_-_Sav_Development.png?ex=6543d64b&is=6531614b&hm=6c67d9c3c1d7849987102a4b14dfa6645d6ed4f1341054a26c09e2cd81d9b32f&"
        },
        thumbnail = {
            url = "https://cdn.discordapp.com/attachments/1152154696304304198/1154462827684319373/PFP_-_Sav_Development.png?ex=6543d64b&is=6531614b&hm=6c67d9c3c1d7849987102a4b14dfa6645d6ed4f1341054a26c09e2cd81d9b32f&"
        }
    }
...
local function RequestApi(method, endpoint, jsondata)
    ...
    PerformHttpRequest(formattedEndpoint, function(errorCode, resultData, resultHeaders)
        ...
        ['X-Audit-Log-Reason'] = 'Sav Development',
    })
    while result == nil do
        Wait(0)
    end
